...
const WrapperToken = ({ text, index, hasWhitespace, linebreaksCount }) => {
    ...
    <span data-i={index}>
      ...
      <span
        dangerouslySetInnerHTML={{
          __html: Array(linebreaksCount).fill("<br />").join(" "),
        }}
      />
    </span>
  );
...
WrapperToken.propTypes = {
  ...
  linebreaksCount: PropTypes.number,
};
      ...
      {splits.map((split, idx) => {
        ...
        return mark ? (
          ...
          <WrapperToken
            ...
            linebreaksCount={linebreaksCount}
          />
        );
        // return split.mark ? (
        //   renderMark({
